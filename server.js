...
const youtube = new YouTube("AIzaSyCgLBLM8Uv1xBFhnvKJ4g7paf8JSUMQVFg "); //تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "new")) {
    ...
    if (!message.guild.roles.exists(gg => gg.name === "Support Team"))
      return message.channel.send(`PLEASE MAKE ROLE AND NAME ITا \`Support Team\`.`);
    if (
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@647142424333910037>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
